...
#dataset_train = pd.read_csv('/content/gdrive/MyDrive/Colab Notebooks/BTC-USD-TRAIN.csv')
dataset_train = pd.read_csv('D:/Dropbox/IFAL-SI/8_Periodo/Sistemas Inteligentes/intelligent-systems/aprendizagem_de_maquina/redes_neurais/google_stock_price_train_rnn.csv')
...
dataset_test = pd.read_csv('D:/Dropbox/IFAL-SI/8_Periodo/Sistemas Inteligentes/intelligent-systems/aprendizagem_de_maquina/redes_neurais/google_stock_price_test_rnn.csv')
